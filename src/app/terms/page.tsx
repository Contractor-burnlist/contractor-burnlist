  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mb-10 rounded border border-amber-300 bg-amber-50 px-4 py-3 text-xs text-amber-800">
        ...
        <section>
          <h2 className="mb-3 border-b border-[#e5e7eb] pb-2 text-lg font-bold text-[#111111]">5. Privacy and Anonymity</h2>
        ...
        <section>
          <h2 className="mb-3 border-b border-[#e5e7eb] pb-2 text-lg font-bold text-[#111111]">6. Content Ownership and License</h2>
        ...
        <section>
          <h2 className="mb-3 border-b border-[#e5e7eb] pb-2 text-lg font-bold text-[#111111]">7. Dispute and Removal Process</h2>
        ...
        <section>
          <h2 className="mb-3 border-b border-[#e5e7eb] pb-2 text-lg font-bold text-[#111111]">9. Disclaimer of Warranties</h2>
        ...
        <section>
          <h2 className="mb-3 border-b border-[#e5e7eb] pb-2 text-lg font-bold text-[#111111]">10. Limitation of Liability</h2>
        ...
        <section>
          <h2 className="mb-3 border-b border-[#e5e7eb] pb-2 text-lg font-bold text-[#111111]">11. Indemnification</h2>
        ...
        <section>
          <h2 className="mb-3 border-b border-[#e5e7eb] pb-2 text-lg font-bold text-[#111111]">12. Account Termination</h2>
        ...
        <section>
          <h2 className="mb-3 border-b border-[#e5e7eb] pb-2 text-lg font-bold text-[#111111]">13. Governing Law</h2>
