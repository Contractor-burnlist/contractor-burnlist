  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mb-8 rounded border border-amber-300 bg-amber-50 px-4 py-3 text-xs text-amber-800">
        Last updated: April 2026. These terms were drafted as a framework and should be reviewed by a licensed attorney before relying on them for legal protection.
      </div>

      <div className="space-y-10 text-sm leading-relaxed text-[#4b5563]">

        <section>
          <h2 className="mb-3 text-lg font-bold text-[#111111]">1. Acceptance of Terms</h2>
        ...
        <section>
          <h2 className="mb-3 text-lg font-bold text-[#111111]">2. Platform Description</h2>
          ...
          <p className="mt-2">Contractor Burnlist does <strong>not</strong> verify, endorse, edit, or assume responsibility for user-submitted content. Contractor Burnlist is a neutral platform provider and does not participate in, mediate, or adjudicate disputes between users and reported parties. All content on this Platform represents the personal experiences and opinions of individual contractors.</p>
        </section>

        <section>
          <h2 className="mb-3 text-lg font-bold text-[#111111]">3. Section 230 Safe Harbor</h2>
          ...
          <p className="mt-2">Contractor Burnlist provides a neutral forum and does not editorially control, modify, or endorse the content submitted by users. Users who submit content are solely responsible for their submissions and any legal consequences arising therefrom.</p>
        </section>

        <section>
          <h2 className="mb-3 text-lg font-bold text-[#111111]">4. User Responsibilities and Conduct</h2>
        ...
        <section>
          <h2 className="mb-3 text-lg font-bold text-[#111111]">5. Privacy and Anonymity</h2>
        ...
        <section>
          <h2 className="mb-3 text-lg font-bold text-[#111111]">6. Content Ownership and License</h2>
        ...
        <section>
          <h2 className="mb-3 text-lg font-bold text-[#111111]">7. Dispute and Removal Process</h2>
          <p>If any individual believes a report about them is false or defamatory, they may submit a dispute request to <a href="mailto:support@contractorburnlist.com" className="font-semibold text-[#DC2626] hover:underline">support@contractorburnlist.com</a>.</p>
          <p className="mt-2">Contractor Burnlist will review disputes in good faith but is under no obligation to remove content. Contractor Burnlist does not adjudicate the truth of reports — we provide the platform, not the verdict. Filing a dispute does not guarantee removal or modification of any content. Repeated frivolous dispute requests may be ignored.</p>
        </section>

        <section>
          <h2 className="mb-3 text-lg font-bold text-[#111111]">8. Subscriptions and Payments</h2>
          <ul className="list-disc space-y-1.5 pl-5">
        ...
        <section>
          <h2 className="mb-3 text-lg font-bold text-[#111111]">9. Disclaimer of Warranties</h2>
        ...
        <section>
          <h2 className="mb-3 text-lg font-bold text-[#111111]">10. Limitation of Liability</h2>
          <p>To the fullest extent permitted by law, Contractor Burnlist, its owners, operators, employees, and affiliates shall not be liable for any direct, indirect, incidental, consequential, special, or punitive damages arising from or related to the use of the Platform.</p>
          <p className="mt-2">This includes but is not limited to: damages arising from reliance on content, loss of business, reputational harm, or any disputes between users and reported parties. In no event shall the total liability of Contractor Burnlist exceed the amount paid by the user in the twelve (12) months preceding the claim.</p>
        </section>

        <section>
          <h2 className="mb-3 text-lg font-bold text-[#111111]">11. Indemnification</h2>
          <p>You agree to indemnify, defend, and hold harmless Contractor Burnlist, its owners, operators, employees, and affiliates from and against any and all claims, damages, losses, liabilities, costs, or expenses (including reasonable attorney&apos;s fees) arising from or related to your submissions, your use of the Platform, or your violation of these Terms &amp; Conditions.</p>
        </section>

        <section>
          <h2 className="mb-3 text-lg font-bold text-[#111111]">12. Account Termination</h2>
        ...
        <section>
          <h2 className="mb-3 text-lg font-bold text-[#111111]">13. Governing Law</h2>
          <p>These Terms &amp; Conditions shall be governed by and construed in accordance with the laws of the State of California, without regard to its conflict of law principles. Any legal action or proceeding arising under these terms shall be brought exclusively in the state or federal courts located in Riverside County, California.</p>
        </section>

        <section>
          <h2 className="mb-3 text-lg font-bold text-[#111111]">14. Contact</h2>
