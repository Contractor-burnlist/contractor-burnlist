    ...
    <div className="min-h-screen bg-white">
      <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <section>
          ...
          <p className="mt-3 rounded border border-[#DC2626]/20 bg-[#DC2626]/5 px-4 py-3 text-xs font-semibold text-[#DC2626]">Contractor Burnlist is NOT a consumer reporting agency as defined by the Fair Credit Reporting Act (FCRA), 15 U.S.C. &sect; 1681 et seq. Information on this platform may not be used for any purpose governed by the FCRA, including but not limited to: employment screening, tenant screening, credit decisions, insurance underwriting, or any other purpose that would require compliance with the FCRA.</p>
